...
export const createCheckoutSession = async (req, res) => {
  try {
    ...
    // ✅ FIXED: Proper variant handling (same as Cart component)
    ...
    // Save order with human-readable variant string (SAME AS CART DISPLAY)
    const order = await orderModel.create({
      ...
      items: cartItems.map((i) => ({
        ...
        price: i.price,
        quantity: i.qty,
        variant: getVariantDisplay(i.variant), // ✅ FIXED
      })),
      subtotal,
      shippingFee,
      totalPrice: total,
